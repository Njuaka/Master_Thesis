...
def load_datasets(train_indices, val_indices, meta, args, augment_func, data=None):
    ...
    #labels = {}  # Dictionary to store column data

    # Extract data from all columns and convert to numpy arrays
    #for col_name in meta.columns:
        #labels[col_name] = meta[col_name].values
...
if __name__ == "__main__":
    ...
    # Prepare a dictionary to hold column values
    labels = {}

    # Iterate over all columns in the DataFrame # Store column values in the dictionary
    for col_name in meta.columns:
        labels[col_name] = meta[col_name].values

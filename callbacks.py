...
class ValidationMonitor(keras.callbacks.Callback):
    ...
    #f1_metric = MacroF1(noc=208, threshold=0.5)
    ...
    def do(self, logs):
        ...
        #f1_metric.update_state(all_labels, all_preds)
        #macro_f1 = f1_metric.result()
        ...
        if self.max is None or (macro_f1 - self.max) > self.epsilon:
